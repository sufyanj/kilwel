...
array(
"<3 POWERD BY <me> BOT SITE: kaka.ga <3",
)),
...
return ' '.$jam.' <3 HUMSE JALNE WALE JAL JAL K KALE HOGYE <3   <3 HUM PY MARTI UNKI BEHNY WO HAMARE SALE HOGYE <3 <3______________________ <3 GANGSTER BOT TEAM <3 <3 OWNER <3 SUFYAN JAN  <3 <3 <  '.$nae.'
 '.$hr;
}
